...
const homepageColoredLogos = [
  ...
  "/Brian_Moses_Main_Page_Logos/Frame 1000007702.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007703.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007704.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007705.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007706.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007707.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007708.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007709.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007710.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007711.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007712.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007713.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007714.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007715.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007716.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007717.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007718.png",
  "/Brian_Moses_Main_Page_Logos/Frame 1000007719.png",
    ...
    <>
      ...
      <section className="relative py-16 md:py-20">
        ...
        <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
          ...
          {/* Media Logos - top row (affiliate logos) */}
          <div className="flex flex-nowrap justify-center items-center gap-3 sm:gap-4 md:gap-6 lg:gap-8 w-full overflow-x-auto">
            {[
              "/affiliate/Frame 1000007701.png",
              "/affiliate/Frame 1000007702.png",
              "/affiliate/Frame 1000007703.png",
              "/affiliate/Frame 1000007704.png",
              "/affiliate/Frame 1000007715.png",
              "/affiliate/Frame 1000007716.png",
            ].map((src, index) => {
              // Encode the path to handle spaces and special characters
