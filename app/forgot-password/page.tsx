...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage(data.message || "If an account exists, you will receive a password reset link shortly.");
    } catch {
    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-8 shadow-2xl shadow-black/50 backdrop-blur-xl">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white md:text-3xl">Forgot password</h1>
          <p className="mt-1 text-white/50 text-sm">Enter your email to receive a reset link</p>
