...
export default function AboutBeginning({
  ...
  paragraphs = [
    ...
    "By his early twenties, the cycle of struggle seemed unbreakable. Brian found himself $40,000 in debt, living in 1 bedroom apartment, and battling a deep, quiet depression. He was working 100 hours a week, yet falling further behind every month. The \"system\" he had been told to follow—work hard, make more calls, knock on more doors, get your name out there, keep your head down—was failing him.",
    "It was in this moment of total desperation that Brian made a radical decision. He wasn't just going to \"try harder\"—he was going to change the rules entirely. He realized that the only way out was to re-invent how real estate sales was conducted… He created systems and processes that are tried, tested and proven. Thousands of agents are using the Brian's system for sales to scale their business and create amazing lives! You can have it too & you deserve it!",
  ],
