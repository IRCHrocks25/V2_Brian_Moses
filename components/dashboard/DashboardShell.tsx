  ...
  return (
    <div className="min-h-screen transition-colors duration-300 bg-slate-50 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-50 p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl bg-white dark:bg-white/[0.08] border border-slate-200 dark:border-white/10 shadow-lg text-slate-600 dark:text-white/80 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
      ...
      <aside
        className={`fixed left-0 top-0 h-full w-72 max-w-[85vw] flex flex-col z-40 transition-transform duration-300 ease-out md:translate-x-0 ${
      ...
      >
        <div className="flex-1 m-2 md:m-4 rounded-2xl bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.06] backdrop-blur-xl shadow-xl dark:shadow-2xl dark:shadow-black/20 overflow-hidden transition-colors duration-300 flex flex-col">
          ...
          <div className="px-4 md:px-6 pb-2">
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-100 dark:bg-white/[0.04]">
